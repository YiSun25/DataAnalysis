...
# save results1
res_folder = f"Results_Folder_AftMid/Data_Results1_AftMid_RHU_NEW/N{FFT_R2.N}"
...
print('#######', In_n_word)
print('#######', Data_n_word) # the last one is the output data word, don't need to change.

TF_n_word_list = []
mean_SQNR_flp_fxp_list3 = []

for stage in range(FFT_R2.stages-2): # skip last two stages(-j and -1)
