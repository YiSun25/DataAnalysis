# -*- coding: utf-8 -*-
"""
Created on Thu May 16 14:56:16 2024
...
# save results1
res_folder = f"Results_Folder_new/Data_Results9/N{FFT_R2.N}"
...
for stage in range(FFT_R2.stages-2): # skip last stage
    if stage == 0:
