...
# save results
res_folder = f"Results_Folder/Data_Results2/N{FFT_R2.N}"
...
for stage in range(FFT_R2.stages-2):  # skip last two stages, last stages TF are -j and 1
    for TF_Wordlen in range(16, 0, -1):
        ...
        for In_vec in random_inputs:
            ...
            FFT_R2.FFT_Fixed(In_vec, In_n_word, Data_n_word, TF_n_word)
            FFT_R2.sqnr_calculation()
            SQNR_list4.append(FFT_R2.SNR_flp_fxp)
