...
data_folder = os.path.join(current_dir, "Results_Folder_AftMid/Data_Results1_AftMid/N64")
...
plt.xticks(fontsize=12)  # 设置 x 轴的刻度标签为 9 到 15
...
plt.text(specific_x_value, y_coordinate_for_text, 'W_TF changing stage by stage', color='g', ha='left', va='bottom',fontsize = 12)
...
# plt.text(5, target_value5, ' 54.131 ', fontsize=8, color='red', ha='left', va="top") #给某个点加入文字注释
# plt.plot(5, target_value5, marker='o', color='red', markersize = 5) # 给某个点改变颜色

# target_value6 = SQNR_values[6]
# plt.text(6, target_value6, ' 58.183 ', fontsize=8, color='red', ha='left', va="bottom") #给某个点加入文字注释
...
# plt.text(10, target_value10, ' 53.673 ', fontsize=8, color='red', ha='left',va="top" ) #给某个点加入文字注释
...
# # plt.text(12, target_value12, ' 34.078 ', fontsize=8, color='red', ha='left', va="top") #给某个点加入文字注释
...
# save figure
figure_folder = "Results_Folder_AftMid/Data_Results1_AftMid"
file_name = f"N64_{SQNR_Req}dB_E1_R2.pdf"
...
target_value0 = SQNR_values[0]
plt.text(0, target_value0, ' 64.275 ', fontsize=8, color='red', ha='left', va="bottom") #给某个点加入文字注释
plt.plot(0, target_value0, marker='o', color='red', markersize = 5) # 给某个点改变颜色

target_value4 = SQNR_values[4]
plt.text(4, target_value4, ' 41.060 ', fontsize=8, color='red', ha='left', va="top") #给某个点加入文字注释
plt.plot(4, target_value4, marker='o', color='red', markersize = 5) # 给某个点改变颜色

target_value5 = SQNR_values[5]
plt.text(5, target_value5, ' 47.047 ', fontsize=8, color='red', ha='left', va="bottom") #给某个点加入文字注释
plt.plot(5, target_value5, marker='o', color='red', markersize = 5) # 给某个点改变颜色

target_value8 = SQNR_values[8]
plt.text(8, target_value8, ' 43.841 ', fontsize=8, color='red', ha='left', va="top") #给某个点加入文字注释
plt.plot(8, target_value8, marker='o', color='red', markersize = 5) # 给某个点改变颜色

target_value9 = SQNR_values[9]
plt.text(9, target_value9, ' 45.767 ', fontsize=8, color='red', ha='left',va="bottom" ) #给某个点加入文字注释
plt.plot(9, target_value9, marker='o', color='red', markersize = 5) # 给某个点改变颜色

target_value11 = SQNR_values[11]
plt.text(11, target_value11, ' 44.011 ', fontsize=8, color='red', ha='left', va="top") #给某个点加入文字注释
plt.plot(11, target_value11, marker='o', color='red', markersize = 5) # 给某个点改变颜色

target_value12 = SQNR_values[12]
plt.text(12, target_value12, ' 45.404 ', fontsize=8, color='red', ha='left', va="bottom") #给某个点加入文字注释
plt.plot(12, target_value12, marker='o', color='red', markersize = 5) # 给某个点改变颜色

target_value19 = SQNR_values[19]
plt.text(19, target_value19, ' 41.684 ', fontsize=8, color='red', ha='left', va="top") #给某个点加入文字注释
plt.plot(19, target_value19, marker='o', color='red', markersize = 5) # 给某个点改变颜色

target_value20 = SQNR_values[20]
plt.text(20, target_value20, ' 45.404 ', fontsize=8, color='red', ha='left', va="bottom") #给某个点加入文字注释
...
target_value6 = SQNR_values[6]
plt.text(6, target_value6, ' 29.094 ', fontsize=8, color='red', ha='left', va="top") #给某个点加入文字注释
plt.plot(6, target_value6, marker='o', color='red', markersize = 5) # 给某个点改变颜色
...
# target_value14 = SQNR_values[14]
# plt.text(14, target_value14, ' 54.525 ', fontsize=8, color='red', ha='left', va="top") #给某个点加入文字注释
# plt.plot(14, target_value14, marker='o', color='red', markersize = 5) # 给某个点改变颜色

target_value18 = SQNR_values[18]
plt.text(18, target_value18, ' 30.724 ', fontsize=8, color='red', ha='left', va="top") #给某个点加入文字注释
plt.plot(18, target_value18, marker='o', color='red', markersize = 5) # 给某个点改变颜色
