...
# save result1
res_folder = f"Results_Folder_new/Baseline2_Results/N{FFT_R22.N}"
...
for stage in [1,3]: 
    for D_Wordlen in range(start_word, 0, -1): # reduce the data wordlengh from "start_word"
        ...
        TF_n_word[stage+2] = D_Wordlen
        SQNR_list3 = []
        # print(Data_n_word)
        for In_vec in random_inputs:
            FFT_R22.TF_Gen()
            FFT_R22.FFT_Accuracy(In_vec) # Not to be comitted here. 
