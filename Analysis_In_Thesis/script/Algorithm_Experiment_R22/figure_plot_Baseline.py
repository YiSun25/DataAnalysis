# -*- coding: utf-8 -*-
"""
Created on Sun Jun 16 20:47:00 2024
...
data_folder = os.path.join(current_dir, "Results_Folder_new/Baseline1_Results_new/N64")
...
# 设置横坐标刻度间距
plt.xticks(np.arange(0, 21, 5))  # 设置从 0 到 10，间隔为 1 的刻度
...
plt.text(8, target_value8, ' 31.601 ', fontsize=8, color='red', ha='left',va="top" ) #给某个点加入文字注释
plt.plot(8, target_value8, marker='o', color='red', markersize = 5) # 给某个点改变颜色

target_value9 = SQNR_values[9]
plt.text(9, target_value9, ' 36.982 ', fontsize=8, color='red', ha='left', va="bottom") #给某个点加入文字注释
plt.plot(9, target_value9, marker='o', color='red', markersize = 5) # 给某个点改变颜色

target_value14 = SQNR_values[14]
plt.text(14, target_value14, ' 34.589 ', fontsize=8, color='red', ha='left', va="top") #给某个点加入文字注释
plt.plot(14, target_value14, marker='o', color='red', markersize = 5) # 给某个点改变颜色

target_value15 = SQNR_values[15]
plt.text(15, target_value15, ' 35.866 ', fontsize=8, color='red', ha='left', va="bottom") #给某个点加入文字注释
...
# # save figure
figure_folder = "Results_Folder_new/Baseline1_Results_new"
file_name = f"N64_{SQNR_Req}dB_Base1_R22"
